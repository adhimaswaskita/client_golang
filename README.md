...
[![CI](https://github.com/adhimaswaskita/client_golang/actions/workflows/go.yml/badge.svg)](https://github.com/adhimaswaskita/client_golang/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/adhimaswaskita/client_golang)](https://goreportcard.com/report/github.com/adhimaswaskita/client_golang)
[![Go Reference](https://pkg.go.dev/badge/github.com/adhimaswaskita/client_golang.svg)](https://pkg.go.dev/github.com/adhimaswaskita/client_golang)
...
milestone](https://github.com/adhimaswaskita/client_golang/milestone/2). The v2
development happens in a [separate
branch](https://github.com/adhimaswaskita/client_golang/tree/dev-v2) for the time
...
[![Go Reference](https://pkg.go.dev/badge/github.com/adhimaswaskita/client_golang/prometheus.svg)](https://pkg.go.dev/github.com/adhimaswaskita/client_golang/prometheus)

The
[`prometheus` directory](https://github.com/adhimaswaskita/client_golang/tree/main/prometheus)
contains the instrumentation library. See the
[guide](https://prometheus.io/docs/guides/go-application/) on the Prometheus
website to learn more about instrumenting applications.

The
[`examples` directory](https://github.com/adhimaswaskita/client_golang/tree/main/examples)
contains simple examples of instrumented code.

## Client for the Prometheus HTTP API

[![Go Reference](https://pkg.go.dev/badge/github.com/adhimaswaskita/client_golang/api.svg)](https://pkg.go.dev/github.com/adhimaswaskita/client_golang/api)

The
[`api/prometheus` directory](https://github.com/adhimaswaskita/client_golang/tree/main/api/prometheus)
